function Animation(r, ell) {
    ...
    b.initRoot = function () {
        ...
        b.root.setAttribute("viewBox",
            a.xi + " " + a.yi + " " + r.Fw + " " + r.Fh);
        b.scene = document.getElementById(ell);
        b.scene.appendChild(b.root);
    };
    b.initDefs = function () {
        var a = b.createTag("g"), c = b.createTag("defs");
        a.appendChild(c);
    ...
    b.processFont = function (a) {
        ...
        for (var d = a.fo.length; f < d; f++) {
            var g = a.fo[f], e = b.createTag("glyph");
    ...
    b.processText = function (a) {
        var c = b.createTag("g"), f = b.createTag("defs"), d = b.createTag("g");
        if ("rs" in a)for (var g = 0; a.rs[g]; g++) {
            var e = a.rs[g];
            if (a.tt == "html") {
                var j = a.bd, o = document.createTextNode(e.tx), h = document.createElement("span");
    ...
    b.processShape = function () {
        var a = function (a, d, g) {
            ...
            for (var j = a.length; c < j; c++) {
                var o = a[c], h = b.createTag("stop"), k;
    ...
    b.filterElement = function (a, c) {
        var f = {"0": "Shadow", "1": "Blur", "2": "Glow", "3": "Bevel"}, d = function (a) {
        ...
        this.Rgb = function (a) {
            var c =
                ["R", "G", "B"], d = b.createTag("feComponentTransfer");
            d.setAttribute("in", a);
        ...
        this.init = function () {
            var a = this.filters.rt, c = this.filters.rc;
    ...
    b.sprite.prototype.replaceShape = function (a) {
        var c = this.par.firstChild.nextSibling, b = this.createShape(a), d = a.d;
        if (this.depths[d]) {
            var g = this.par.getAttribute("id") + ":" + d + ":" + this.depths[d], e = document.getElementById(g);
            if (g == b.id)return e;
            c.replaceChild(b, e);
    ...
    b.sprite.prototype.removeShape = function (a) {
        if (this.depths[a]) {
            var c = this.depths[a], b = this.par.firstChild.nextSibling;
    ...
    b.sprite.prototype.mxTransform = function (a, c) {
        var b = {mask: "moveShape", shape: "moveShape", text: "moveText", sprite: "moveSprite", button: "moveButton"};
    ...
    b.sprite.prototype.moveButton = function (a, c) {
        var f = c.d, d = this.depths[c.d], g = c.ma, e = b.hash[c.id];
        if (!this.buttons) this.buttons = {};
        if (this.buttons[f + ":" + d])for (var j in e = this.buttons[f + ":" + d].sprites, e)e[j].showFrame(); else this.buttons[f + ":" + d] = new b.sprite.Button(a, e);
    ...
    b.sprite.Button.prototype = {
        init: function (a) {
            ...
            var o = this.element, h = this.states, k = this.sprites;
    ...
    b.sprite.prototype.colorTransform = function () {
        function a(a, b) {
            var d = a.match(/rgb\(([^(]+)\)/)[1].split(","), g = Math.max(0, Math.min((d[0] - 0) * b.Rm / 256 + b.Ra, 255)), e = Math.max(0, Math.min((d[1] - 0) * b.Gm / 256 + b.Ga, 255));
            ...
            if ((d ==
                ...
                try {
                    for (var g = 0, e = d.childNodes.length; g < e; g++) {
                        var j = d.childNodes[g], o = b, h = j.hasAttribute("stroke") ? "stroke" : "fill", k = j.getAttribute(h);
                        if (k)switch (k.match(/^\S{3}/)[0]) {
                            ...
                            case "url":
                                ...
                                if (r.nodeName != "pattern") {
                                    var s = l.parentNode.previousSibling, t = l.parentNode.parentNode.getAttribute("id") + q;
                                    if (document.getElementById(t))var u = document.getElementById(t); else u = r.cloneNode(!0), u.setAttribute("id", t), s.appendChild(u);
                                    var w = r.childNodes, x = u.childNodes;
                                    n = 0;
                                    for (var y = w.length; n < y; n++) {
                                        var z = w[n].getAttribute("stop-color"), v = a(z, o);
    ...
    b.start = function () {
           ...
           a.setAttribute("id", "ani" + Math.random());
           ...
           b.timer = setTimeout(function () {
               if (c.frame == c.frames.length - 1) {
                   animationStop = true;
                   c.frame = 0;
                   b.timer = setTimeout(arguments.callee, b.interval);
               } else {
                   !animationStop && c.showFrame();
                   b.timer = setTimeout(arguments.callee, b.interval);
               }
           }, b.interval);
    ...
    b.setBackground = function (a) {
        var c = b.createTag("rect"), f = {x: r.Ft.xi, y: r.Ft.yi, width: r.Fw, height: r.Fh, fill: r.Bg}, d;
